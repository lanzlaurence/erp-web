        ...
        <>
            ...
            <div className="mx-auto max-w-4xl space-y-6 p-4">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Add a new vendor</p>
                </div>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <ReactSelect
                                    ...
                                    placeholder={selectedCountry ? "Select or search state/province..." : "Select country first"}
                                    className="react-select-container"
                                    classNamePrefix="react-select"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <ReactSelect
                                    ...
                                    placeholder={selectedState ? "Select or search city..." : "Select state/province first"}
                                    className="react-select-container"
                                    classNamePrefix="react-select"
                                />
                            </div>
