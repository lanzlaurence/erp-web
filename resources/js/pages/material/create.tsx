...
import type { Brand, Category, Uom } from '@/types';
    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-4xl space-y-6 p-4">
                <div>
                    <h1 className="text-2xl font-semibold">Create Material</h1>
                    <p className="text-sm text-muted-foreground">Add a new material to inventory</p>
                </div>
...
Create.layout = (page: React.ReactNode) => (
    <AppLayout
        breadcrumbs={[
            ...
            { title: 'Create', href: '/materials/create' },
        ]}
    >
        {page}
    </AppLayout>
